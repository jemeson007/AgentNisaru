 ...
 * Description:
 *
 * This is a simulator game engine for offline simultaneous experiments.
 * Only line "TacRandom.setSeed(seed);" is added from GameEngineSimultaneous.
 * Make sure if you change GameEngineSimultaneous, change this class too.
 * 
 */
...
public class GameEngineOfflineSimultaneous extends GameEngineOffline {

	public GameEngineOfflineSimultaneous(SimulatedAgent[] a, int g) {
		super(a, g);
	}
